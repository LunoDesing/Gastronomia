...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (botonesComida.length > 0 && pedidoContainer && totalPedidoElement) {
        ...
        function construirMensajeConfirmacion(nombre, mensaje, direccion, calles, piso, total, detalles) {
            ...
            mensajeConfirmacion += `--Recuerda adjuntar el comprobante por aquí y al impactar el pago enviamos tu pedido.--\n`;
        ...
        function construirMensajeConfirmacionLocal2(nombre, detalles) {
            ...
            mensajeConfirmacionLocal2 += `*Nombre de quien pidió:* ${nombre}\n\n`;
            ...
            mensajeConfirmacionLocal2 += `*También puedes abonar en efectivo en el local ó por transferencia:*\n`;
